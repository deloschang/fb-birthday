...
DATABASES = {
    'default': {
        ...
        'NAME': 'birthday',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'vk$t@p+(#p!8q9by-79trmz)4!453j_v)@j*r0xo_80+hywfnc'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    "/Users/deloschang/Documents/self_projects/birthday/webapp/templates"
